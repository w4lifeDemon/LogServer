...
//made by Zmei Комменты
			...
			*/
			...
			if ($intSumLosses != 0) {
				...
				$strAttacker = "<font color='" . WHITE_DARK . "'>" . "<b>" . Dictionary("att_total_losses") . ": " . "<font color='" . RED_COMMON . "'>" . NumberToString($this->objSource->arrCombatResult->generic->units_lost_attackers) . "</font>" ." (100%)" . "</font>" . "</b><br>";
				...
				$strDefender = "<font color='" . WHITE_DARK . "'>" . "<b>" . Dictionary("def_total_losses") . ": " . "<font color='" . RED_COMMON . "'>" . NumberToString($this->objSource->arrCombatResult->generic->units_lost_defenders). "</font>" . " (100%)" . "</font>" . "</b><br>";
